...
<body>
    ...
    $id = $_GET['id'];
    $category = Category::getCategoryFromID($pdo,$id);
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        $name = $_POST['name'];
        $cate = new Category($name);
        $cate->updateCategoryInDatabase($pdo,$id);
        header('Location: ./index.php');
    }
?>
    <div class="m-3">
        <h3 style="text-shadow: 2px 2px #cdcdcd">Edit Category</h3>
        <form method="POST" class="row p-3 w-25 m-auto"
            ...
            <div class="col-md-12">
                ...
                <input type="text" value="<?= $category['CategoryName'] ?>" name="name" class="form-control"
