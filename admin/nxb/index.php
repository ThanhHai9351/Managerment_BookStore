...
?>
    <div class="p-3">
        <h3 class="mb-4 mx-3" style="text-shadow: 2px 2px #cdcdcd">NXB</h3>
        <a class="btn btn-primary m-3" href="./create.php">Create a NXB</a>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-warning" style="display: inline-block;"
                        href="./edit.php?id=<?= $NXB['ID'] ?>">Edit</a>
                    <a class="btn btn-danger" style="display: inline-block;" data-bs-toggle="modal"
                        data-bs-target="#exampleModal" href="" data-id="<?= $NXB['ID'] ?>">Delete</a>
                </td>
            </tr>
            <?php
            endforeach;
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="delete.php" method="post">
                        <input type="hidden" name="nxb_id" id="nxb-id">
...
?>
    ...
    if (exampleModal) {
        exampleModal.addEventListener('show.bs.modal', event => {
            ...
            const NXBID = button.getAttribute('data-id')

            document.getElementById('nxb-id').value = NXBID
        })
    }
    </script>
