...
<body>
    ...
    $id = $_GET['id'];
    $NXB = NXB::getNXBFromID($pdo,$id);
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        $name = $_POST['name'];
        $NXBtemp = new NXB($name);
        $NXBtemp->updateNXBInDatabase($pdo,$id);
        header('Location: ./index.php');
    }
?>
    <div class="m-3">
        <h3 style="text-shadow: 2px 2px #cdcdcd">Edit NXB</h3>
        <form method="POST" class="row p-3 w-25 m-auto"
            ...
            <div class="col-md-12">
                ...
                <input type="text" value="<?= $NXB['NXBName'] ?>" name="name" class="form-control"
