...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $NXBID = $_POST['NXBID'];
        $product = new Product($name,$price,$quantity,$image,$description,$authorID,$categoryID,$NXBID);
        $product->insertProductInDatabase($pdo);
    ...
    <div class="m-3">
        ...
        <form method="POST" class="row p-3"
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="Image" class="form-control" placeholder="Enter the image URL">
            </div>
            <div class="col-md-6">
