...
<head>
    ...
    <link rel="mask-icon" type=""
        ...
        color="#111" />
    <link rel="canonical"
        href="https://codepen.io/brookjordan/pen/XNgmGq?depth=everything&order=popularity&page=95&q=translate&show_forks=false" />
    ...
    <div class="container" id="fore-particles">
        <svg class="moko-404" viewbox="0 0 500 400">
            ...
            <path d="M231.2 127.8s.6 5.7-3.6 7-7.4-5.3-11.4-9-8.4-1.5-9.3-6c-1-4.8 5.4-2.3 5.4-2.3l10.7 8z"
                class="moko-404__b" />
            <ellipse cx="210.5" cy="116.9" class="moko-404__c" rx="4.7" ry="4.5"
            ...
            <ellipse cx="264.3" cy="125.1" class="moko-404__c" rx="4.9" ry="5"
            ...
            <path class="pupilR1 pupilR4 moko-404__l"
            ...
            <path class="pupilL3 moko-404__l"
...
/* ----------------------------------------------- */
    ...
    var pJS = function(tag_id, params) {
        ...
        pJS.fn.particle = function(color, opacity, position) {
            ...
            if (typeof(color.value) == 'object') {
                ...
                if (color.value instanceof Array) {
                    var color_selected = color.value[Math.floor(Math.random() * pJS.particles.color.value
                        .length)];
                    this.color.rgb = hexToRgb(color_selected);
                } else {
                    if (color.value.r != undefined && color.value.g != undefined && color.value.b !=
                        undefined) {
                        this.color.rgb = {
                            r: color.value.r,
                            g: color.value.g,
                    ...
                    if (color.value.h != undefined && color.value.s != undefined && color.value.l !=
                        undefined) {
                        this.color.hsl = {
                            h: color.value.h,
                            s: color.value.s,
        ...
        pJS.fn.vendors.drawShape = function(c, startX, startY, sideLength, sideCountNumerator,
    ...
    animate('.moko-404', {
        ...
        frames: 5,
        frameNames: 'leafO stemO leafN stemN leafM stemM leafL stemL leafK stemK leafJ stemJ leafI stemI leafH leafG stemG leafF stemF leafE stemE leafD stemD leafC stemC leafB stemB leafA stemA eyeL eyeR pupilL pupilR'
            .split(' '),
        repeat: true,
        close: true
    });
